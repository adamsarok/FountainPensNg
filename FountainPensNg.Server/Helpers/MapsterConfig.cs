    ...
    public static class MapsterConfig {
        public static void RegisterMapsterConfiguration(this IServiceCollection services) {
            ...
            config.NewConfig<Paper, SearchResultDTO>()
                .Map(dest => dest.SearhResultType, src => SearhResultTypes.Paper.ToString());
            config.NewConfig<FountainPen, SearchResultDTO>()
                .Map(dest => dest.SearhResultType, src => SearhResultTypes.Pen.ToString());
            config.NewConfig<Ink, SearchResultDTO>()
                .Map(dest => dest.SearhResultType, src => SearhResultTypes.Ink.ToString());
        }
    }
}
